...
import '../models/slidergroup8110_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application5/core/app_export.dart';

// ignore: must_be_immutable
class Slidergroup8110ItemWidget extends StatelessWidget {
  Slidergroup8110ItemWidget(this.slidergroup8110ItemModelObj,
      {this.onTapImgUser, this.onTapImgRectangle9322});

  Slidergroup8110ItemModel slidergroup8110ItemModelObj;
          ...
          Card(
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgEllipse4109,
                    height: getVerticalSize(
                      103,
                    ),
                    width: getHorizontalSize(
