...
import '../models/slidergroup8109_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application5/core/app_export.dart';

// ignore: must_be_immutable
class Slidergroup8109ItemWidget extends StatelessWidget {
  Slidergroup8109ItemWidget(this.slidergroup8109ItemModelObj,
      {this.onTapImgRectangle9322});

  Slidergroup8109ItemModel slidergroup8109ItemModelObj;
          ...
          Card(
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  CustomImageView(
                    imagePath: ImageConstant.imgEllipse4105,
                    height: getVerticalSize(
                      103,
                    ),
                    width: getHorizontalSize(
