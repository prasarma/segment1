...
import '../models/listcheckmark8_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application5/core/app_export.dart';
import 'package:pra_s_application5/widgets/custom_icon_button.dart';

// ignore: must_be_immutable
class Listcheckmark8ItemWidget extends StatelessWidget {
  Listcheckmark8ItemWidget(this.listcheckmark8ItemModelObj);

  Listcheckmark8ItemModel listcheckmark8ItemModelObj;
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Obx(
                            () => Text(
                              listcheckmark8ItemModelObj.upipaymentTxt.value,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Obx(
                            () => Text(
                              listcheckmark8ItemModelObj.sixtyTxt.value,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                              style: AppStyle.txtHelveticaNeueBold12Gray800,
                            ),
