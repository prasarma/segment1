...
import '../models/listsk1_item_model.dart';
import 'package:flutter/material.dart';
import 'package:pra_s_application5/core/app_export.dart';

// ignore: must_be_immutable
class Listsk1ItemWidget extends StatelessWidget {
  Listsk1ItemWidget(this.listsk1ItemModelObj);

  Listsk1ItemModel listsk1ItemModelObj;

  var controller = Get.find<EntityDetailsIndividualsOneController>();
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Obx(
                () => Text(
                  listsk1ItemModelObj.k02aaaci1195h1zyOneTxt.value,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
              ...
              Padding(
                ...
                child: Obx(
                  () => Text(
                    listsk1ItemModelObj.skenterprisesTxt.value,
                    overflow: TextOverflow.ellipsis,
                    textAlign: TextAlign.left,
        ...
        Spacer(),
        CustomImageView(
          svgPath: ImageConstant.imgCheckmarkGreen500,
          height: getSize(
            16,
          ),
          width: getSize(
